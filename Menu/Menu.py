...
class Menu:
    def __init__(self):
        ...
        self.mute_img = pygame.transform.scale(pygame.image.load(f'assets/music_images/mute.png'), (30, 30))
        self.unmute_img = pygame.transform.scale(pygame.image.load(f'assets/music_images/unmute.png'), (30, 30))
    def execute(self):
        running = True
        ...
        mute_img = pygame.image.load(f'assets/music_images/mute.png')
        unmute_img = pygame.image.load(f'assets/music_images/unmute.png')
        
        new_width = 50  # Đặt width mong muốn
        mute_ratio = mute_img.get_height() / mute_img.get_width()
        unmute_ratio = unmute_img.get_height() / unmute_img.get_width()
        
        new_height_mute = int(new_width * mute_ratio)
        new_height_unmute = int(new_width * unmute_ratio)
        
        mute_img = pygame.transform.scale(mute_img, (new_width, new_height_mute))
        unmute_img = pygame.transform.scale(unmute_img, (new_width, new_height_unmute))
        button_music = pygame.Rect(15, 550, mute_img.get_width(), mute_img.get_height())
        ...
        while running:
            ...
            self.screen.blit(unmute_img if utils.isMusic else mute_img, (15, 550))
            # Lấy vị trí chuột
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    if button_music.collidepoint(event.pos):
                        utils.isMusic = not utils.isMusic
